...
G4VPhysicalVolume *DetectorConstruction::Construct() {
  ...
  G4VPhysicalVolume *physDet =
      new G4PVPlacement(rotationMatrix, G4ThreeVector(0.5 * cm, 0., 0.5 * cm),
